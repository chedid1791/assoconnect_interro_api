        ...
        try {
            ...
            Foreach ($Contact in $Response.'hydra:member') {
                If ($contact.Type -eq "PERSON") {
                    ...
                    Rôle = $Contact.customFields."Role"
                    Atelier = $Contact.customFields."Atelier"
                    Présence = $Contact.customFields."Presence-aux-ateliers"
                    Droit_image = $Contact.customFields."Droit-a-l-image"
                    ...
                    Saison = $Contact.customFields."Saison-s"."01KQQEBKKYC66PFHZK5J28P5NF"
                    ...
                    Autorisation_rentrée = $contact.custumfield."Autorise-e-a-rentrer-seul-e"
                    ...
                    Adresse_parent_1 = $Contact.customFields."Adresse-parent-1_dKrAFtYoEFNd"
                    ...
                    Adresse_parent_2 = $Contact.customFields."Adresse-parent-2_oxACE6SSQVZg"
                    ...
                    DT_Adm_Numérique_Sécurité_Communication = $Contact.customFields."DT-Administrateur-informatique"."01HPGXR2BV04QJZSDX5FQHF9PF"
